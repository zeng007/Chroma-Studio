        ...
        <div class="row ftco-animate">
          <div class="col-md-12">
            <div class="carousel-client owl-carousel">
              ...
              <div class="item">
                <a href="#" class="client text-center p-5">
            	  <img src="images/Logo_3.jpg"  width="250" height="40">
                </a>
              </div>
              <div class="item">
                <a href="#" class="client text-center p-5">
